...
const ListeningTrueFalse = ({ question, onChange }) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-gray-200 space-y-3">
      <p className="text-xs font-bold text-gray-500 uppercase mb-2">Chọn đáp án đúng:</p>
      ...
      {!question.correct_answer && (
        <p className="text-xs text-red-500 italic mt-1">* Vui lòng chọn một đáp án.</p>
      )}
    </div>
  );
};
