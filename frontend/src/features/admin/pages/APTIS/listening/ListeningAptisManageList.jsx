...
const ListeningAptisManageList = () => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      render: (text) => (
        <Space>
          ...
          <Text strong style={{ color: '#3730a3', fontSize: '15px' }}>{text}</Text>
        </Space>
      ),
    },
    {
    ...
    },
    {
      ...
      align: 'center',
      render: (isMock) => (
        <Tag color={isMock ? 'purple' : 'geekblue'} bordered={false} style={{ borderRadius: 20, fontWeight: 500 }}>
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 16px' }}>
      ...
      >
        ...
        <Table
          ...
          rowClassName={() => 'listening-test-row'}
          style={{ marginTop: 8 }}
        />
      </Card>
    </div>
