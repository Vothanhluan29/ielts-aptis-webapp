...
const WritingAptisManagerList = () => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      render: (text) => (
        <Space>
          ...
          <Text strong style={{ color: '#4c1d95', fontSize: '15px' }}>{text}</Text>
        </Space>
      ),
    },
    {
    ...
    },
    {
      ...
      align: 'center',
      render: (isMock) => (
        <Tag color={isMock ? 'magenta' : 'geekblue'} bordered={false} style={{ borderRadius: 20, fontWeight: 500 }}>
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 16px' }}>
      ...
      >
        ...
        <div style={{
          ...
          <Space size="large">
            <div style={{
              padding: '12px', backgroundColor: '#f5f3ff',
              borderRadius: '14px', color: '#7c3aed',
