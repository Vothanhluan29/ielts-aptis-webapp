...
const ReadingListPage = () => {
  ...
  const getStatusConfig = (status, testId) => {
    ...
    // NOT_STARTED — Blue to match Reading brand
    return {
      tagColor: 'blue',
      text: 'Not Started',
      ...
      isStartBtn: true,
      showRetry: false,
      cardBg: 'linear-gradient(135deg, #eff6ff 0%, #dbeafe 60%, #bfdbfe 100%)',
      cardBorder: '#93c5fd',
      hoverBg: 'linear-gradient(135deg, #dbeafe 0%, #bfdbfe 60%, #93c5fd 100%)',
    };
  };
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    <Button
                      ...
                      className={`h-11 rounded-xl font-bold flex items-center justify-center gap-2 ${config.isStartBtn ? 'bg-blue-600' : 'bg-white/80'}`}
                    >
                      {config.mainBtnText}
                      <ArrowRight size={18} />
                    </Button>
