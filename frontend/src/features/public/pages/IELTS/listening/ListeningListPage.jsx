...
const ListeningListPage = () => {
  ...
  const getStatusConfig = (status, testId) => {
    ...
    // NOT_STARTED — Teal to match Listening brand
    return {
      tagColor: 'cyan',
      text: 'Not Started',
      ...
      isStartBtn: true,
      showRetry: false,
      cardBg: 'linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 60%, #99f6e4 100%)',
      cardBorder: '#5eead4',
      hoverBg: 'linear-gradient(135deg, #ccfbf1 0%, #99f6e4 60%, #5eead4 100%)',
    };
  };
    ...
    <div className="w-full max-w-7xl mx-auto p-4 animate-in fade-in duration-500 font-sans bg-transparent">
      ...
      <div className="mb-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div className="p-4 bg-teal-600 text-white rounded-2xl shadow-lg shadow-teal-200">
        ...
        <Space size="middle" wrap>
          ...
          <Button
            ...
            className="flex items-center gap-2 rounded-lg font-bold border-slate-200 hover:text-teal-600 shadow-sm h-10"
          >
            History
          </Button>
        </Space>
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    <Button
                      ...
                      className={`h-11 rounded-xl font-bold flex items-center justify-center gap-2 ${config.isStartBtn ? 'bg-teal-600' : 'bg-white/80'}`}
                    >
                      {config.mainBtnText}
                      <ArrowRight size={18} />
                    </Button>
                    ...
                    {config.showRetry && (
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`/listening/exam/${test.id}`);
                        }}
                        style={{
