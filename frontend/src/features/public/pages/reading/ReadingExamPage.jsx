...
import { useReadingExam } from '../../hooks/reading/useReadingExam';
          ...
          <div className="h-full max-w-[1600px] mx-auto px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-bold bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-widest">IELTS Reading</span>
                <h1 className="text-sm font-bold text-slate-800 truncate max-w-xs" title={test.title}>{test.title}</h1>
              </div>
            </div>

            {/* Center: Highlight Tools */}
            <div className="flex items-center gap-3 bg-gradient-to-r from-indigo-50/50 to-blue-50/50 px-4 py-2 rounded-lg border border-indigo-200">
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={() => handleSubmit(false)} disabled={submitting} className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-lg font-bold text-sm hover:from-indigo-700 hover:to-blue-700 shadow-md disabled:from-slate-400 disabled:to-slate-400 transition-all">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 h-full divide-x-2 divide-indigo-200">
            ...
            <div id="reading-text-wrapper" className="bg-white h-full overflow-y-auto scroll-smooth" style={{scrollbarWidth: 'thin', scrollbarColor: '#818cf8 #f1f5f9'}}>
              <div className="p-8 md:p-12 max-w-4xl mx-auto">
                <div className="bg-gradient-to-br from-white to-slate-50 border-2 border-indigo-200 rounded-lg shadow-sm p-8 md:p-10">
