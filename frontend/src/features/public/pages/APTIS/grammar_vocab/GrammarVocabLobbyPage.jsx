          ...
          >
            ...
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              <div style={{ 
                ...
                width: 80, height: 80, borderRadius: '50%', backgroundColor: '#ecfdf5', color: '#10b981', marginBottom: 16 
              }}>
            ...
            <Row gutter={[16, 16]} style={{ marginBottom: 32 }}>
              <Col xs={24} sm={12}>
                <div style={{ padding: '20px', backgroundColor: '#f8fafc', borderRadius: 16, border: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', gap: 16 }}>
                  <ClockCircleOutlined style={{ fontSize: 28, color: '#10b981' }} />
                  <div>
              ...
              <Col xs={24} sm={12}>
                <div style={{ padding: '20px', backgroundColor: '#f8fafc', borderRadius: 16, border: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', gap: 16 }}>
                  <FileDoneOutlined style={{ fontSize: 28, color: '#3b82f6' }} />
                  <div>
                    <Text type="secondary" style={{ display: 'block', fontSize: 13, textTransform: 'uppercase', letterSpacing: 1 }}>
                      Total Questions
                    </Text>
            ...
            <div style={{ marginBottom: 32 }}>
              <Title level={4} style={{ marginBottom: 16, color: '#334155' }}>
                Aptis Grammar & Vocabulary Test Structure:
              </Title>
              <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                <div className="flex items-start gap-3">
                  <CheckCircleFilled style={{ color: '#10b981', marginTop: 4, fontSize: 16 }} />
                  <Paragraph style={{ margin: 0, fontSize: 15, color: '#475569' }}>
                    <Text strong>Part 1 - Grammar:</Text> Includes 25 multiple-choice questions. You will choose the best answer from three options to fill in the blank.
                  </Paragraph>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircleFilled style={{ color: '#10b981', marginTop: 4, fontSize: 16 }} />
                  <Paragraph style={{ margin: 0, fontSize: 15, color: '#475569' }}>
                    <Text strong>Part 2 - Vocabulary:</Text> Includes 25 questions with tasks such as matching synonyms, filling words in context, matching phrases, and matching definitions.
                  </Paragraph>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircleFilled style={{ color: '#10b981', marginTop: 4, fontSize: 16 }} />
                  <Paragraph style={{ margin: 0, fontSize: 15, color: '#475569' }}>
                    <Text strong>Scoring:</Text> The test is graded automatically. Each correct answer earns 1 point (Maximum 50 points).
                  </Paragraph>
                </div>
              </Space>
            </div>
...
export default GrammarVocabLobbyPage;