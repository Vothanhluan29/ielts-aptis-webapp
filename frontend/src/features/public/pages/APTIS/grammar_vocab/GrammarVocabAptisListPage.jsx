...
import { BookMarked, Clock, CheckCircle, AlertCircle, ArrowRight, History, RotateCcw, Play } from 'lucide-react';
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{
              ...
              <BookMarked size={28} color="#fff" strokeWidth={2.5} />
            </div>
            <div>
              ...
              <p style={{ margin: 0, fontSize: 13, color: '#6b7280', marginTop: 2 }}>
                Grammar &amp; Vocabulary theo chuẩn British Council APTIS
              </p>
            </div>
          </div>
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <BookMarked size={32} color="#6366f1" />
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20 }}>
          {filteredTests.map(test => {
            ...
            const isDone = test.status === 'GRADED';
              ...
              >
                <div style={{ padding: '20px 20px 16px' }}>
                  ...
                  <p style={{
                    ...
                    {test.description || 'Multiple-choice test with 2 parts: Grammar (25 questions) and Vocabulary (25 questions).'}
                  </p>
                </div>
