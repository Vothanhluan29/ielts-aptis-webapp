    ...
    switch (status) {
      ...
      default:
        return {
          ...
          mainBtnAction: () => handleNavigateExam(testId),
          mainBtnStyle: {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: 13, color: '#6b7280', marginTop: 2 }}>
                Writing skills following the British Council APTIS structure
              </p>
            </div>
          </div>
              ...
              >
                <div style={{ padding: '20px 20px 16px' }}>
                  ...
                  <p style={{
                    ...
                    {test.description || 'Practice all 4 Writing parts following the official APTIS format.'}
                  </p>
                </div>
                ...
                <div style={{ padding: '12px 20px 20px', display: 'flex', flexDirection: 'column', gap: 8, marginTop: 'auto' }}>
                  ...
                  >
                    {config.isDone ? <><History size={15} /> {config.mainBtnText}</> : <><Play size={15} /> {config.mainBtnText} <ArrowRight size={15} /></>}
                  </button>
