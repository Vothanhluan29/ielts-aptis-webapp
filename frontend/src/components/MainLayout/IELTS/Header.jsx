...
const Header = ({
  ...
  return (
    <header className="h-20 bg-sky-50 border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4 relative" ref={profileRef}>
        ...
        <button
          ...
          className="w-10 h-10 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold shadow hover:opacity-90 transition-opacity overflow-hidden"
        >
          {user?.avatar_url ? (
            <img
              src={user.avatar_url}
        ...
        {/* DROPDOWN */}
        {profileOpen && (
          <div className="absolute right-0 top-14 w-60 bg-white border border-slate-200 rounded-xl shadow-lg">
            ...
            <div className="p-2">
              <Link
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-sky-50 transition-colors"
              >
                <User size={16} />
                Profile
              </Link>
